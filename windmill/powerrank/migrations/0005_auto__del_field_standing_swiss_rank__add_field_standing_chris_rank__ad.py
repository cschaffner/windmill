...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Standing.swiss_rank'
        db.delete_column('powerrank_standing', 'swiss_rank')

        # Adding field 'Standing.chris_rank'
        db.add_column('powerrank_standing', 'chris_rank',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Standing.mark_rank'
        db.add_column('powerrank_standing', 'mark_rank',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Standing.swiss_rank'
        db.add_column('powerrank_standing', 'swiss_rank',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Standing.chris_rank'
        db.delete_column('powerrank_standing', 'chris_rank')

        # Deleting field 'Standing.mark_rank'
        db.delete_column('powerrank_standing', 'mark_rank')
