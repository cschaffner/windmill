...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Game.upset_current'
        db.delete_column('powerrank_game', 'upset_current')

        # Deleting field 'Game.upset_overall'
        db.delete_column('powerrank_game', 'upset_overall')

        # Adding field 'Game.pred_margin_current'
        db.add_column('powerrank_game', 'pred_margin_current',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'Game.pred_margin_overall'
        db.add_column('powerrank_game', 'pred_margin_overall',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Game.upset_current'
        db.add_column('powerrank_game', 'upset_current',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'Game.upset_overall'
        db.add_column('powerrank_game', 'upset_overall',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4, blank=True),
                      keep_default=False)

        # Deleting field 'Game.pred_margin_current'
        db.delete_column('powerrank_game', 'pred_margin_current')

        # Deleting field 'Game.pred_margin_overall'
        db.delete_column('powerrank_game', 'pred_margin_overall')
