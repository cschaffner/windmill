...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sms_sms', (
            ...
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tools.Team'])),
            ('round_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('tournament', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tools.Tournament'])),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=540)),
            ...
            ('createTime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('submitTime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('sentTime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('receivedTime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
