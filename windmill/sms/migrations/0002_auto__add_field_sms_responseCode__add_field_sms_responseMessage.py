...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SMS.responseCode'
        db.add_column('sms_sms', 'responseCode',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SMS.responseMessage'
        db.add_column('sms_sms', 'responseMessage',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SMS.responseCode'
        db.delete_column('sms_sms', 'responseCode')

        # Deleting field 'SMS.responseMessage'
        db.delete_column('sms_sms', 'responseMessage')
