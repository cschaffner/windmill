...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SMS.createTime'
        db.alter_column('sms_sms', 'createTime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):

        # Changing field 'SMS.createTime'
        db.alter_column('sms_sms', 'createTime', self.gf('django.db.models.fields.DateTimeField')(null=True))
