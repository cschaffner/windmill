...
class Migration(SchemaMigration):
    ...
    models = {
        'sms.sms': {
            ...
            'team': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tools.Team']", 'blank': 'True'}),
            'tournament': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tools.Tournament']", 'blank': 'True'})
        },
        'tools.team': {
