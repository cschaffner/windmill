...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SMS.tournament'
        db.alter_column('sms_sms', 'tournament_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tools.Tournament'], null=True))

        # Changing field 'SMS.team'
        db.alter_column('sms_sms', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tools.Team'], null=True))

    def backwards(self, orm):

        # Changing field 'SMS.tournament'
        db.alter_column('sms_sms', 'tournament_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tools.Tournament']))

        # Changing field 'SMS.team'
        db.alter_column('sms_sms', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tools.Team']))

    models = {
        'sms.sms': {
            'Meta': {'object_name': 'SMS'},
            'createTime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'team': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['tools.Team']", 'null': 'True', 'blank': 'True'}),
            'tournament': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['tools.Tournament']", 'null': 'True', 'blank': 'True'})
        },
        'tools.team': {
