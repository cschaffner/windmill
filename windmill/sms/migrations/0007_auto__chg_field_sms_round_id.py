...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SMS.round_id'
        db.alter_column('sms_sms', 'round_id', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

    def backwards(self, orm):

        # Changing field 'SMS.round_id'
        db.alter_column('sms_sms', 'round_id', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        'sms.sms': {
            ...
            'round_id': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
