...
url='{0}/v1/tournament_teams/?tournament_ids=%5B{1}%5D'.format(HOST,tournament_id) 
next=True  
while next:
    ...
    for team in response_dict.get('objects'):
        ...
        remove_url='{0}/v1/tournament_teams/{1}/{2}/'.format(HOST,tournament_id,team.get('team_id'))
